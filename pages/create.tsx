...
import { Sparkles, Plus, Users, TrendingUp, Star, Zap, ExternalLink } from 'lucide-react';
...
export default function Create() {
  ...
  return (
    <>
      <Head>
        <title>Context Collection - コンテキストを作成</title>
        <meta
          name="description"
          content="ユーザーインタビューのための高品質なコンテキストを簡単に作成。生成したプロンプトはChatGPT、Claude、Gemini等で利用可能。"
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
        
        <meta property="og:title" content="Context Collection - コンテキスト作成" />
        <meta property="og:description" content="ユーザーインタビューを加速するコンテキストを生成" />
            ...
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">ユーザーインタビュー用コンテキスト作成</p>
                </div>
              </div>
              
              <nav className="hidden md:flex items-center space-x-1">
                <Link href="/" className="nav-item flex items-center space-x-1">
                  <span>🗂 コレクション</span>
                </Link>
                <button className="nav-item nav-item-active">✍️ 作成</button>
              ...
              <div className="text-center space-y-6 animate-slide-up">
                <div className="inline-flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-soft">
                  ...
                  <span className="text-sm font-medium text-gray-700">
                    ユーザーインタビュー用のコンテキストを簡単生成
                  </span>
                </div>
                
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
                  高品質な
                  <span className="bg-gradient-to-r from-mint-500 to-peach-500 bg-clip-text text-transparent">コンテキスト</span>
                  を作成
                </h2>
                
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  対象ユーザー像や状況、制約、回答の口調まで。
                  インタビューの精度を上げるための情報を適切に整理したプロンプトを生成します。
                </p>

                <div className="flex flex-wrap gap-3 justify-center pt-4">
                  <div className="tag-category">🎯 リサーチ</div>
                  <div className="tag-category">👨‍💼 ビジネス</div>
                  <div className="tag-category">📚 アカデミック</div>
                  <div className="tag-category">🧪 検証</div>
                </div>
              </div>
            </div>
          </section>
              ...
              <>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                  <div className="card p-6 text-center">
                    ...
                    <div className="text-sm text-gray-600 mt-1">作成済みコンテキスト</div>
                  </div>
                  <div className="card p-6 text-center">
